...
*** IBM Watson
    ...
    - [[http://qiita.com/zuhito/items/e9f39adc3f25951daf95][コーディング不要で画像認識APIを活用したアプリを開発する - Qiita]]
...
*** indico
    - [[https://indico.io/][indico | text and image analysis powered by machine learning]]
